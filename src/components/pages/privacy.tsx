...
const Privacy = () => {
  ...
  const renderContent = () => {
    switch (selectedPage) {
      case "terms":
        return <p>Terms of Use content goes here...</p>;
      case "privacy":
        return (
          <>
            ...
            <p>
              {/* Your full Privacy Policy content here */}
              1. Privacy Policy
                            ...
                            Information associated with or used to identify or contact a specific person. Personal Information includes: (1) contact data (such as name, address, postal address, e-mail address, telephone number and employer); (2) financial information (such as credit card number or connection with your bank account); (3) demographic data (such as gender, date of birth and zip code); and (4) certain Usage Data (defined below), such as IP address.
                            ...
                            • technical information, including your browser type, service provider, IP address, operating system and webpages visited;• information about what you've searched for and looked at while using the Website; or• metadata, which means information related to items you made available through the Website, such as the date, time or location that a shared photograph or video was taken or posted.
                            ...
                            • the location of the mobile device or computer used to access the Website derived from GPS or WiFi use;• the IP address of the mobile device or computer or internet service used to access the Website; and; and• other information made available by a user or others that indicates the current or prior location of the user.5. How We Collect Information
                            Whether we collect certain types of information and how we process it depends on how you use and access the Website. Some information is collected automatically through use of cookies and similar data collection tools. We collect information about you in the following ways: From You
                            We collect information from you when you:
                            • Use our services. We collect Personal Information from you when you create an account to use one of our services, contact us for help or information or otherwise voluntarily provide your Personal Information.• Connect with social media though the Website. The Website may offer you the ability to use Facebook Connect or other social media services (collectively, "Social Media") in conjunction with certain services. When you access the Website through your Facebook or other Social Media account, the Website may, depending on your privacy settings, have access to information that you have provided to the Social Media platform. We may use this information for the purposes described in section 6.
...
We may combine the information we collect from you with information from other sources and use the combined information as described in this privacy policy.
                            ...
                            All computers have the ability to decline cookies. This can be done by activating the setting on your browser which enables you to decline the cookies. Please note that should you choose to decline cookies, you may be unable to access particular parts of our Website.
                                                        ...
                                                        We may process the information we collect/you provide to us primarily to enable us to provide our services to you. In addition, we may use the information for the following purposes:
                            • to operate, improve and personalize the products and services we offer, and to give each user a more consistent and personalized experience when interacting with us;• for customer service, security, to detect fraud or illegal activities, or for archival and backup purposes in connection with the provision of services;• to communicate with users and to notify them about any changes to our Website, such as improvements or service/product changes, that may affect our services;• to better understand how users access and use the Website, for the purposes of trying to improve our services and to respond to user preferences, including language and location customization, personalized help and instructions, or other responses to users' usage of the Website;• to help us develop our new products and services and improve our existing products and services;• to provide users with advertising and direct marketing that is more relevant to you;• to enforce any other applicable policies; and• to assess the effectiveness of and improve advertising and other marketing and promotional activities on or in connection with the Website.
                            ...
                            • in the event that we sell or buy any business or assets, in which case we may disclose your Personal Information to the prospective seller or buyer of such business or assets;• if we or substantially all of our assets are acquired by a third party, in which case personal data held by us about our customers will be one of the transferred assets;• if we are under a duty to disclose or share your Personal Information in order to comply with any legal obligation or in order to enforce or apply our Website Terms and other agreements, but we will endeavor to minimise such disclosure to only that reasonably necessary and, where possible, to provide you with notice of such disclosure; and/or• to protect the rights, property, or safety of Nuqi, the Website, our users and any third party we interact with to provide the Website.• If you do not want us to use your data, you will have the opportunity to withhold your consent to this when you provide your details to us on the form on which we collect your data, or you can do so by writing to us• In the same manner, if you have given us consent to use your data for a particular purpose you can revoke or vary that consent at any time.
                            To perform services
...
Copyright © 2023 Nuqi Wealth / All rights reserved.
DISPUTE & JURISDICTION :-This will be governed by the Laws of India and any disputes arising herein shall be subject to the exclusive jurisdiction of the Courts of Mumbai. {/* Truncated for brevity */}
            </p>
          </>
        );
      case "disclaimer":
        return <p>Disclaimer content goes here...</p>;
      case "cookie":
        return <p>Cookie Policy content goes here...</p>;
      default:
        ...
        <div className="flex flex-col lg:flex-row gap-6">
          ...
          <div className="lg:w-1/4 w-full p-4 rounded-lg shadow-lg">
            <ul className="space-y-4">
              <li>
                <button
                  className={`block py-3 px-4 w-full text-left rounded-3xl transition-colors duration-200 ${
              ...
              <li>
                <button
                  className={`block py-2 px-4 w-full text-left rounded-3xl transition-colors duration-200 ${
                    selectedPage === "terms"
                      ? "bg-cyan-400 text-white font-semibold"
          ...
          {/* Main Content */}
          <div className="lg:w-3/4 w-full p-8 rounded-lg shadow-lg ">
            <div className="text-left">
              <h2 className="text-3xl sm:text-4xl font-bold leading-tight text-white pb-6 border-b border-[#32363e]">
                {selectedPage === "privacy"
                  ? "Privacy Policy"
                  : selectedPage === "terms"
                  ? "Terms of Use"
