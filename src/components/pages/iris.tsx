...
const Iris = () => {
  ...
  return (
    <section className="py-5 sm:py-16 lg:py-1">
      ...
      <div className="flex flex-wrap gap-4 p-4 bg-black rounded-lg shadow-md ml-4 mt-5">
        <div className="flex flex-wrap gap-4 w-full justify-center sm:justify-start sm:flex-col md:flex-row lg:flex-row">
