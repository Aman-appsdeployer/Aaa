...
const features: InvestmentFeature[] = [
  {
    ...
    description: "Explore a vast selection of over 3000 meticulously vetted individual stocks, along with access to 11 expertly curated equity portfolios."
  },
  {
  ...
  {
    title: "Robo Advisory",
    description: "Robo Advisory service coupled with a team of successful qualified Investment advisors to advice on individual investment portfolios."
  },
  {
    title: "Regulated and secure",
    description: "A DFSA licensed and regulated company partnered with leading financial institutions and backed by strong data encryptions. Seamless and secure execution with our broker partners"
  }
];
  ...
  return (
    <div className="py-16 px-10 bg-black max-md:px-5">
      <div className="flex gap-12 max-md:flex-col items-stretch">
        {/* Image Section */}
        <div className="flex w-[45%] max-md:w-full">
          <img
            loading="lazy"
