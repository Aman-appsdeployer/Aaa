    ...
    <div className="rounded-none">
      <div className="flex gap-10 items-center max-md:flex-col">
        ...
        <div className="flex flex-col w-[44%] ml-12 max-md:ml-0 max-md:w-full">
          <div className="self-stretch text-5xl font-medium tracking-tighter leading-tight text-cyan-400 max-md:mt-10 max-md:max-w-full max-md:text-4xl">
            <span className="text-white">{highlightedText} </span>
            {title}
          </div>
          {/* Description Section */}
          <div className="mt-6 text-lg leading-8 text-white max-md:text-base max-md:leading-7">
            {description}
          </div>
        </div>
